<?php
    ...
    class ProductoDAO extends Model {
        ...
        public setVenta($valortotal, $valordescuentos, $valoriva, $idcliente){
            $this->connect();
            $restult = $this->query("INSERT INTO venta (numerofactura, valortotal, valordescuentos, valoriva, idcliente) 
